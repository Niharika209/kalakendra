...
function LandingPage() {
  return (
    <>
      ...
      <section className="min-h-screen py-20 px-6 flex items-center justify-center bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-lg md:text-xl text-center text-[#45453e] mb-16 max-w-3xl mx-auto">
            Discover diverse traditional and contemporary art forms from around the world
          </p>
          
          {/* Artform cards */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white/90 backdrop-blur-sm rounded-xl p-6 shadow-lg hover:shadow-2xl transition-all hover:scale-105 cursor-pointer border border-[#45453e]/10">
              <div className="h-48 bg-linear-to-br from-yellow-200 to-orange-300 rounded-lg mb-4 flex items-center justify-center">
                <span className="text-4xl">🎨</span>
              </div>
              <h3 className="text-xl font-semibold text-[#45453e] mb-2">Painting</h3>
              <p className="text-[#45453e]/70">Traditional and modern painting techniques</p>
            </div>
            <div className="bg-white/90 backdrop-blur-sm rounded-xl p-6 shadow-lg hover:shadow-2xl transition-all hover:scale-105 cursor-pointer border border-[#45453e]/10">
              <div className="h-48 bg-linear-to-br from-yellow-200 to-orange-300 rounded-lg mb-4 flex items-center justify-center">
                <span className="text-4xl">💃</span>
              </div>
              <h3 className="text-xl font-semibold text-[#45453e] mb-2">Dance</h3>
              <p className="text-[#45453e]/70">Classical and contemporary dance forms</p>
            </div>
            <div className="bg-white/90 backdrop-blur-sm rounded-xl p-6 shadow-lg hover:shadow-2xl transition-all hover:scale-105 cursor-pointer border border-[#45453e]/10">
              <div className="h-48 bg-linear-to-br from-yellow-200 to-orange-300 rounded-lg mb-4 flex items-center justify-center">
                <span className="text-4xl">🎵</span>
              </div>
              <h3 className="text-xl font-semibold text-[#45453e] mb-2">Music</h3>
              <p className="text-[#45453e]/70">Vocal and instrumental music traditions</p>
            </div>
            <div className="bg-white/90 backdrop-blur-sm rounded-xl p-6 shadow-lg hover:shadow-2xl transition-all hover:scale-105 cursor-pointer border border-[#45453e]/10">
              <div className="h-48 bg-linear-to-br from-yellow-200 to-orange-300 rounded-lg mb-4 flex items-center justify-center">
                <span className="text-4xl">✍️</span>
              </div>
              <h3 className="text-xl font-semibold text-[#45453e] mb-2">Calligraphy</h3>
              <p className="text-[#45453e]/70">Art of beautiful handwriting and lettering</p>
            </div>
            <div className="bg-white/90 backdrop-blur-sm rounded-xl p-6 shadow-lg hover:shadow-2xl transition-all hover:scale-105 cursor-pointer border border-[#45453e]/10">
              <div className="h-48 bg-linear-to-br from-yellow-200 to-orange-300 rounded-lg mb-4 flex items-center justify-center">
                <span className="text-4xl">🗿</span>
              </div>
              <h3 className="text-xl font-semibold text-[#45453e] mb-2">Sculpture</h3>
              <p className="text-[#45453e]/70">Three-dimensional art and pottery</p>
            </div>
            <div className="bg-white/90 backdrop-blur-sm rounded-xl p-6 shadow-lg hover:shadow-2xl transition-all hover:scale-105 cursor-pointer border border-[#45453e]/10">
              <div className="h-48 bg-linear-to-br from-yellow-200 to-orange-300 rounded-lg mb-4 flex items-center justify-center">
                <span className="text-4xl">🧵</span>
              </div>
              <h3 className="text-xl font-semibold text-[#45453e] mb-2">Textile Arts</h3>
              <p className="text-[#45453e]/70">Weaving, embroidery, and fabric design</p>
            </div>
          </div>
        </div>
      </section>
